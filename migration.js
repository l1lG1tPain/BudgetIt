// public/migration.js — мягкий баннер (Montserrat, Акулка с анимацией, кнопки 50/50)
(function () {
  const SHARK_SRC   = '/assets/shark.png';
  ...
  .migr-img{
    ...
    animation:shark-swing 3s ease-in-out infinite;
  }
  @keyframes shark-swing {
  ...
  .migr-btn{
    flex:1 1 50%; min-width:calc(50% - 6px);
  ...
  /* На маленьких экранах кнопки во всю ширину */
